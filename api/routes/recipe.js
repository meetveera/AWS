...
//Upload the image on S3 bucket and image table for user's recipe
...
//Get the image of the User's reciepe
...
//delete image S3 bucket and database
            ...
            if(error){
                ...
                pool.query("SELECT  * FROM Users where email_address = '"+usernameREQ+"'", (error, results2) => {
                    if(error){
                        ...
                        console.log(results2.rows[0].password);
                        var pa = results2.rows[0].password;
                        console.log(pa);
                        bycript.compare(passwordREQ, pa, (error, result) => {
                            if(error){
